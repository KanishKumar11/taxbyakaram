      ...
      <div className="max-w-7xl mx-auto space-y-10 p-6">
        <div className="bg-[#96259C] text-white p-10 rounded-xl text-center flex flex-col items-center">
          ...
          <p className="text-lg mt-2">
            We at TaxByAkrom are here to handle it all for you.
          </p>
        ...
        <div>
          <h3 className="text-3xl font-bold">Documents needed to file ITR-2</h3>
          <p className="mt-2">
            Filing Income Tax Return (ITR-2) in India requires you to gather
